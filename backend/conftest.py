...
def fixture_user_custom_without_link_expiration_access():
    return baker.make_recipe("user_profile.custom_custom_user_without_link_expiration_access", _quantity=2)
...
def fixture_auth_client_custom_without_link_expiration_access(user_custom_without_link_expiration_access) -> APIClient:
    client = APIClient()
